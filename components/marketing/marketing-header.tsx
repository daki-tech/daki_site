    ...
    <>
      <header className="sticky top-0 z-50 w-full bg-background">
        <div className="mx-auto relative flex h-16 max-w-[1800px] items-center justify-between px-2 lg:px-3">
          ...
          <Link
            href="/"
            className="font-logo absolute left-1/2 -translate-x-1/2 text-[34px] tracking-[0.04em] uppercase lg:static lg:translate-x-0"
          >
            DAKI
          </Link>
        ...
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-[300px] bg-background shadow-xl">
            <div className="flex h-16 items-center justify-between border-b border-border px-4">
              <span className="font-logo text-2xl tracking-[0.04em] uppercase">DAKI</span>
              <button
