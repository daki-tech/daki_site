...
export const metadata: Metadata = {
  title: "Каталог",
  description: "Каталог верхнього жіночого одягу DaKi — пальта, пуховики, куртки, жилети. Оптові та роздрібні ціни від виробника.",
  openGraph: {
    title: "Каталог — DaKi",
    description: "Верхній жіночий одяг від українського виробника. Пальта, пуховики, куртки оптом та в роздріб.",
  },
};
