  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-12 lg:px-6 lg:py-20">
      ...
      <div className="mx-auto mt-12 grid max-w-3xl gap-5 sm:grid-cols-2">
        {/* Phone card */}
        {phones.length > 0 && (
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-neutral-200 bg-neutral-50/50 p-8 transition-all hover:border-neutral-400 hover:shadow-sm">
        ...
        {email && (
          <a
            href={`mailto:${email}`}
            className="flex flex-col items-center gap-3 rounded-2xl border border-neutral-200 bg-neutral-50/50 p-8 transition-all hover:border-neutral-400 hover:shadow-sm"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-neutral-900 text-white">
        ...
        <div className="mt-14 text-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            {socials.map(({ href, icon: Icon, label }) => (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-neutral-200 text-neutral-500 transition-all group-hover:border-neutral-900 group-hover:bg-neutral-900 group-hover:text-white">
