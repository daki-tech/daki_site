...
- "personal" → Личное (личные расходы владельцев бизнеса, всё что для семьи/себя)
- "salary" → Зарплата (выплаты швеям, конструкторам, любому персоналу)
- "hardware" → Фурнитура/кнопки (молнии, пуговицы, кнопки, бирки, нитки)
...
🔴 КРИТИЧЕСКОЕ ПРАВИЛО — РАЗДЕЛЕНИЕ ЛИЧНОЕ vs БИЗНЕС:

Бизнес DaKi — это пошив женской верхней одежды (пальто, пуховики, куртки, тренчи, парки, жилеты). К БИЗНЕСУ относится ТОЛЬКО то, что напрямую идёт в производство одежды:
- Материалы пошива (ткань, фурнитура, нитки, молнии, пуговицы, бирки, утеплитель, подклад)
- Расходы цеха (аренда помещения, электричество, вода, ремонт швейных машин, инструменты)
- Зарплата персоналу (швеи, конструкторы, технологи, помощники)
- Разработка коллекции (лекала, образцы, услуги дизайнера, тестовые отшивы)

ВСЁ ОСТАЛЬНОЕ — это "personal" (Личное), даже если человек не сказал слово "личное":
- Еда, продукты, кофе, обед, рестораны, доставка → personal
- Своя одежда (свитер, кроссовки, рубашка, джинсы) → personal
- Машина (бензин, масло, ремонт авто, шиномонтаж, страховка) → personal
- Дом и быт (бытовая химия, мебель, техника, ремонт квартиры) → personal
- Здоровье, аптека, врач, стоматолог → personal
- Развлечения, кино, подарки, путешествия → personal
- Подписки, телефон, интернет личный → personal
- Любое "себе/семье/маме/жене/ребёнку" → personal

Если сомневаешься между бизнес-категорией и personal — выбирай personal. Лучше попасть в личное, чем испортить бизнес-учёт.

Слово "ткань" в контексте одежды на себя ("купил ткань на пальто себе") — это всё равно НЕ бизнес. Бизнес-ткань — это покупка для производства партии изделий.
...
"купил свитер 2000":
{"action":"expense","amount":2000,"category":"personal","description":"свитер","currency":"грн","raw_transcript":"...","confidence":0.95}

"поменял масло в машине 1500":
{"action":"expense","amount":1500,"category":"personal","description":"масло в машине","currency":"грн","raw_transcript":"...","confidence":0.95}

"обед 350":
{"action":"expense","amount":350,"category":"personal","description":"обед","currency":"грн","raw_transcript":"...","confidence":0.95}

"кофе 80":
{"action":"expense","amount":80,"category":"personal","description":"кофе","currency":"грн","raw_transcript":"...","confidence":0.95}

"купил продукты 1500":
{"action":"expense","amount":1500,"category":"personal","description":"продукты","currency":"грн","raw_transcript":"...","confidence":0.95}

"бензин 1200":
{"action":"expense","amount":1200,"category":"personal","description":"бензин","currency":"грн","raw_transcript":"...","confidence":0.95}

"стоматолог 3000":
{"action":"expense","amount":3000,"category":"personal","description":"стоматолог","currency":"грн","raw_transcript":"...","confidence":0.95}

"подарок жене 5000":
{"action":"expense","amount":5000,"category":"personal","description":"подарок жене","currency":"грн","raw_transcript":"...","confidence":0.95}

"диски на машину 500 долларов":
{"action":"expense","amount":500,"category":"personal","description":"диски на машину","currency":"дол","raw_transcript":"...","confidence":0.95}
